...
\href{https://github.com/asugar13/rl-taxi-pong/blob/main/pong.mp4}{\texttt{pong.mp4}}.}; as a concrete
checkpoint, the $3$-action agent already averages ${\approx}-10$ at just $600$k frames --- a competitive
paddle that returns most balls --- against the original recipe's flat $-21$ across the entire run.
